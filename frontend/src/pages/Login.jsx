...
export default function Login() {
    ...
    const clerkSignIn = CLERK_KEY ? useSignIn() : null;
    const signIn = clerkSignIn?.signIn;
    const isLoaded = clerkSignIn?.isLoaded ?? true;
    ...
    const handleGoogleLogin = async () => {
        if (!signIn || !isLoaded) {
            setError('Google sign-in is not available. Use the demo account below.');
            return;
        }
        setLoading(true);
        setError('');
        ...
        <div className="auth-page">
            <div style={{ width: '100%', maxWidth: '420px' }}>
                <div className="auth-card">
                    ...
                    {/* Demo Login */}
                    <form className="auth-form" onSubmit={handleDemoLogin}>
                        <input
